...
{
	/*
	 * An extra transfer is needed to effectively slow down the
	 * actual exit conversion mode command, so that it should always
	 * succeed even if there are timing issues elsewhere on the bus.
	 */
